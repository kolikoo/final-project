...
className="p-3 bg-[#450920] w-100% mx-auto text-white dark:bg-[#C4D7F2] dark:text-white">{t("SignIn-Page.confirmed")}</button>

<button onClick={()=>handleNavigate("/login/registration")}
 className="p-3 bg-[#450920] w-100% mx-auto text-white dark:bg-[#C4D7F2] dark:text-white">{t("SignIn-Page.tryagain")}</button>
