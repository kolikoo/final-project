...
small:w-[170%]
    ...
    >
      {/* Background Text */}
      <h1
        className="absolute top-[7%] left-[23%] text-[140px] dark:text-white dark:opacity-90 font-serif font-bold text-[#450920] leading-none z-1 xl:text-[150px] xl:left-[23%] lg:text-[130px] lg:left-[20%] large:text-[100px] semimedium:text-[100px] semimedium:left-[21%] semimedium:top-[13%] 
        extramedium:left-[28%]

      small:text-[75px]  small:top-10
      sm:text-[80px] sm:top-[5%]
       medium:text-[60px]
       large:left-[24%]
       large:top-[12%]
       lg:top-[19%]
      ...
      <div className="relative w-full h-full flex items-center justify-center gap-4">
        ...
        <img
          src={marcxena}
          alt="Left Image"
          className="w-[250px] h-[250px] object-cover rounded-md shadow-lg xl:w-[250px] xl:h-[250px] 
          large:w-[250px] large:h-[250px]
           semimedium:w-[200px]  semimedium:h-[200px]
           medium:w-[130px] medium:h-[140px]
           small:w-[100px] small:h-[110px]
           semismall:w-[120px] 
        ...
        <img
          src={shua}
          alt="Center Image"
          className="w-[400px] h-[500px] object-cover rounded-md shadow-xl z-10 xl:w-[400px] xl:h-[500px]
          
          semimedium:w-[300px]  semimedium:h-[400px]
           medium:w-[170px] medium:h-[240px]
          small:w-[100px] small:h-[200px]
          "
        />
        ...
        <img
          ...
          className="w-[200px] h-[300px] object-cover rounded-md shadow-lg
           ...
           semimedium:w-[180px]  semimedium:h-[300px]
           medium:w-[130px] medium:h-[180px]  
           small:w-[100px] small:h-[150px]
